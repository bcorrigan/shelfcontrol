...
fn integration_test() -> Result<(), Error> {
	...
	assert!(result.to_json().contains("charles-darwin_the-origin-of-species.epub\",\"filesize\":94482,\"modtime\""));
	assert!(result.to_json().contains("\"pubdate\":\"2019-01-15T04:52:30Z\",\"moddate\":\"2019-01-15T04:52:30Z\",\"cover_mime\":\"image/jpeg\"}]}"));
